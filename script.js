const options = {
    ...
    shadowblur: {letter: "𐤎", description: "extent of blurry shadow applied to line segments (non-zero values might not play well with some blend modes & negative values use the inverted line color for the shadow) <i>in pixels</i>", min: -10, max: 50, step: 0.1, default: 0},
